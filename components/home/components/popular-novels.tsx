...
export const POPULAR_NOVELS_CATEGORY_ID = "6a9eb5b4463e5a288a801269";
...
export function PopularNovels({
  ...
  const actionHref = `/books?category=${POPULAR_NOVELS_CATEGORY_ID}`;

  return (
    <section id="popular-novels" className={`py-[76px] md:py-[120px] ${className}`}>
